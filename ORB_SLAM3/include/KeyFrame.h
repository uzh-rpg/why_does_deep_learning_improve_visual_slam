...
public:
    ...
    // KeyPoint functions
    std::vector<size_t> GetFeaturesInArea(const float &x, const float  &y, const float  &r, const bool bRight = false, const int minLevel=-1, const int maxLevel=-1) const;
